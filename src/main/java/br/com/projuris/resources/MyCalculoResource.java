...
public class MyCalculoResource {
	
	@GetMapping("/cargo")
	public List<CustoCargo> getCargo () {		
		MyCalculo myCalculo = new MyCalculo();
		
		return myCalculo.custoPorCargo(getList());		
	}
	
	@GetMapping("/departamento")
	public List<CustoDepartamento> getDepartamento () {	
		MyCalculo myCalculo = new MyCalculo();
		
		return myCalculo.custoPorDepartamento(getList());		
	}
	
	private List<Funcionario> getList(){
